...
"border-radius:5px")
    ...
    def Runpage(self):
        ...
        for idate in dayindex:
            ...
            # 查询
            rainfall = [self.browser.find_element_by_xpath('//*[@id="Layer1"]/table/tbody/tr[{}]/td[1]'.format(str(i))).text for i in range(3, 28)]
            hourtemp = [self.browser.find_element_by_xpath('//*[@id="Layer1"]/table/tbody/tr[{}]/td[2]'.format(str(i))).text for i in range(3, 28)]
            maxtemp = [self.browser.find_element_by_xpath('//*[@id="Layer1"]/table/tbody/tr[{}]/td[3]'.format(str(i))).text for i in range(3, 28)]
            mintemp = [self.browser.find_element_by_xpath('//*[@id="Layer1"]/table/tbody/tr[{}]/td[5]'.format(str(i))).text for i in range(3, 28)]
            maxspeed = [self.browser.find_element_by_xpath('//*[@id="Layer1"]/table/tbody/tr[{}]/td[22]'.format(str(i))).text for i in range(3, 28)]
            if self.station in ['句容', '扬中', '丹阳']:
                minvis = [self.browser.find_element_by_xpath('//*[@id="Layer1"]/table/tbody/tr[{}]/td[45]'.format(str(i))).text for i in range(3, 28)]
            elif self.station == '镇江':
                minvis = [self.browser.find_element_by_xpath('//*[@id="Layer1"]/table/tbody/tr[{}]/td[49]'.format(str(i))).text for i in range(3, 28)]
            else:
                minvis = [self.browser.find_element_by_xpath('//*[@id="Layer1"]/table/tbody/tr[{}]/td[23]'.format(str(i))).text for i in range(3, 28)]
